...
public class PanelsView_WithMovesNavigation_And_SearchInfo extends SearchInfoView {
	...
	public void init(String playerName_white, String playerName_black, boolean autotop, boolean autobottom, boolean info_enabled) {
		...
		float play_and_goto_buttons_size_x = 1 * (rectangle_bottom1.right - rectangle_bottom1.left - 2 * delta) / 6;
		float play_and_goto_buttons_border = play_and_goto_buttons_size_x / 4;

		rectangle_area_info.top = rectangle_bottom1.top + (rectangle_bottom1.bottom - rectangle_bottom1.top) / 2 - play_and_goto_buttons_size_y / 2;
		rectangle_area_info.left = rectangle_bottom1.left + (rectangle_bottom1.right - rectangle_bottom1.left) / 2 - play_and_goto_buttons_size_x / 2;
		rectangle_area_info.right = rectangle_area_info.left + play_and_goto_buttons_size_x;
		rectangle_area_info.bottom = rectangle_area_info.top + play_and_goto_buttons_size_y;

		rectf_play_first.top = rectangle_bottom1.top + (rectangle_bottom1.bottom - rectangle_bottom1.top) / 2 - play_and_goto_buttons_size_y / 2;
		...
		rectf_play_prev.top = rectangle_bottom1.top + (rectangle_bottom1.bottom - rectangle_bottom1.top) / 2 - play_and_goto_buttons_size_y / 2;
		...
		rectf_play_last.top = rectangle_bottom1.top + (rectangle_bottom1.bottom - rectangle_bottom1.top) / 2 - play_and_goto_buttons_size_y / 2;
		...
		rectf_play_next.top = rectangle_bottom1.top + (rectangle_bottom1.bottom - rectangle_bottom1.top) / 2 - play_and_goto_buttons_size_y / 2;
