 ...
 *
 */
package bagaturchess.learning.goldmiddle.impl8;
...
import bagaturchess.learning.goldmiddle.impl8.filler.Bagatur_PST_SignalFiller;


public class Bagatur_PST_LearningInputImpl implements ILearningInput {
	...
	public ISignalFiller createFiller(IBitBoard bitboard) {
		return new Bagatur_PST_SignalFiller(bitboard);
	}
	
	
	public String getFeaturesConfigurationClassName() {
		return Bagatur_PST_FeaturesConfigurationImpl.class.getName();
	}
}
