...
public class Bagatur_V17_FeaturesConfigurationImpl implements IFeaturesConfiguration, IFeatureComplexity, Bagatur_V17_FeaturesConstants {
	...
	public IFeature[] getDefinedFeatures() {
		...
		//Imbalance
		add(new_featuresSet, new AdjustableFeatureArray(FEATURE_ID_MATERIAL_IMBALANCE_NIGHT_PAWNS 		, "MATERIAL.IMBALANCE.NIGHT.PAWNS" 		, GROUP1,
				PSTConstants.createArray(9, -256), PSTConstants.createArray(9, 256), PSTConstants.createArray(9, 0),
				PSTConstants.createArray(9, -256), PSTConstants.createArray(9, 256), PSTConstants.createArray(9, 0)
		));
		add(new_featuresSet, new AdjustableFeatureArray(FEATURE_ID_MATERIAL_IMBALANCE_ROOK_PAWNS 		, "MATERIAL.IMBALANCE.ROOK.PAWNS" 		, GROUP1,
				PSTConstants.createArray(9, -256), PSTConstants.createArray(9, 256), PSTConstants.createArray(9, 0),
				PSTConstants.createArray(9, -256), PSTConstants.createArray(9, 256), PSTConstants.createArray(9, 0)
		));
		...
		add(new_featuresSet, new AdjustableFeatureArray(FEATURE_ID_PAWN_CONNECTED 						, "PAWN.CONNECTED" 						, GROUP1,
				PSTConstants.createArray(7, 0), PSTConstants.createArray(7, 256), PSTConstants.createArray(7, 0),
				PSTConstants.createArray(7, 0), PSTConstants.createArray(7, 256), PSTConstants.createArray(7, 0)
		));
		add(new_featuresSet, new AdjustableFeatureArray(FEATURE_ID_PAWN_NEIGHBOUR 						, "PAWN.NEIGHBOUR" 						, GROUP1,
				PSTConstants.createArray(7, 0), PSTConstants.createArray(7, 256), PSTConstants.createArray(7, 0),
				PSTConstants.createArray(7, 0), PSTConstants.createArray(7, 256), PSTConstants.createArray(7, 0)
		));
		...
		add(new_featuresSet, new AdjustableFeatureArray(FEATURE_ID_PAWN_PASSED 							, "PAWN.PASSED" 						, GROUP1,
				PSTConstants.createArray(7, 0), PSTConstants.createArray(7, 256), PSTConstants.createArray(7, 0),
				PSTConstants.createArray(7, 0), PSTConstants.createArray(7, 256), PSTConstants.createArray(7, 0)
		));
		add(new_featuresSet, new AdjustableFeatureArray(FEATURE_ID_PAWN_PASSED_CANDIDATE 				, "PAWN.PASSED.CANDIDATE" 				, GROUP1,
		...
		//Mobility
		add(new_featuresSet, new AdjustableFeatureArray(FEATURE_ID_MOBILITY_KNIGHT 						, "MOBILITY.KNIGHT" 					, GROUP1,
				PSTConstants.createArray(9, -128), PSTConstants.createArray(9, 256), PSTConstants.createArray(9, 0),
				PSTConstants.createArray(9, -128), PSTConstants.createArray(9, 256), PSTConstants.createArray(9, 0)
		));
		add(new_featuresSet, new AdjustableFeatureArray(FEATURE_ID_MOBILITY_BISHOP 						, "MOBILITY.BISHOP" 					, GROUP1,
				PSTConstants.createArray(14, -128), PSTConstants.createArray(14, 256), PSTConstants.createArray(14, 0),
				PSTConstants.createArray(14, -128), PSTConstants.createArray(14, 256), PSTConstants.createArray(14, 0)
		));
		add(new_featuresSet, new AdjustableFeatureArray(FEATURE_ID_MOBILITY_ROOK 						, "MOBILITY.ROOK" 						, GROUP1,
				PSTConstants.createArray(15, -128), PSTConstants.createArray(15, 256), PSTConstants.createArray(15, 0),
				PSTConstants.createArray(15, -128), PSTConstants.createArray(15, 256), PSTConstants.createArray(15, 0)
		));
		add(new_featuresSet, new AdjustableFeatureArray(FEATURE_ID_MOBILITY_QUEEN 						, "MOBILITY.QUEEN" 						, GROUP1,
				PSTConstants.createArray(28, -128), PSTConstants.createArray(28, 256), PSTConstants.createArray(28, 0),
				PSTConstants.createArray(28, -128), PSTConstants.createArray(28, 256), PSTConstants.createArray(28, 0)
		));
		add(new_featuresSet, new AdjustableFeatureArray(FEATURE_ID_MOBILITY_KING 						, "MOBILITY.KING" 						, GROUP1,
				PSTConstants.createArray(9, -128), PSTConstants.createArray(9, 256), PSTConstants.createArray(9, 0),
				PSTConstants.createArray(9, -128), PSTConstants.createArray(9, 256), PSTConstants.createArray(9, 0)
		));
		...
		//Threats
		add(new_featuresSet, new AdjustableFeatureArray(FEATURE_ID_THREAT_DOUBLE_ATTACKED 				, "THREAT.DOUBLE.ATTACKED" 				, GROUP1,
		...
		add(new_featuresSet, new AdjustableFeatureArray(FEATURE_ID_OTHERS_ONLY_MAJOR_DEFENDERS 			, "OTHERS.ONLY.MAJOR.DEFENDERS" 		, GROUP1,
				PSTConstants.createArray(7, -256), PSTConstants.createArray(7, 512), PSTConstants.createArray(7, 0),
				PSTConstants.createArray(7, -256), PSTConstants.createArray(7, 512), PSTConstants.createArray(7, 0)
		));
		add(new_featuresSet, new AdjustableFeatureArray(FEATURE_ID_OTHERS_HANGING 						, "OTHERS.HANGING" 						, GROUP1,
				PSTConstants.createArray(7, 0), PSTConstants.createArray(7, 256), PSTConstants.createArray(7, 0),
				PSTConstants.createArray(7, 0), PSTConstants.createArray(7, 256), PSTConstants.createArray(7, 0)
		));
		add(new_featuresSet, new AdjustableFeatureArray(FEATURE_ID_OTHERS_HANGING_2 					, "OTHERS.HANGING.2" 					, GROUP1,
		...
		add(new_featuresSet, new AdjustableFeatureArray(FEATURE_ID_OTHERS_BISHOP_OUTPOST 				, "OTHERS.BISHOP.OUTPOST" 				, GROUP1,
		...
		add(new_featuresSet, new AdjustableFeatureArray(FEATURE_ID_OTHERS_BISHOP_PAWNS 					, "OTHERS.BISHOP.PAWNS" 				, GROUP1,
		...
		add(new_featuresSet, new AdjustableFeatureArray(FEATURE_ID_OTHERS_PAWN_BLOCKAGE 				, "OTHERS.PAWN.BLOCKAGE" 				, GROUP1,
				PSTConstants.createArray(8, -1024), PSTConstants.createArray(8, 1024), PSTConstants.createArray(8, 0),
				PSTConstants.createArray(8, -1024), PSTConstants.createArray(8, 1024), PSTConstants.createArray(8, 0)
		));
		add(new_featuresSet, new AdjustableFeatureArray(FEATURE_ID_OTHERS_KNIGHT_OUTPOST 				, "OTHERS.KNIGHT.OUTPOST" 				, GROUP1,
				PSTConstants.createArray(8, -1024), PSTConstants.createArray(8, 1024), PSTConstants.createArray(8, 0),
				PSTConstants.createArray(8, -1024), PSTConstants.createArray(8, 1024), PSTConstants.createArray(8, 0)
		));
